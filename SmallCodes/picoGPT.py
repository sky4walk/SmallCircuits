"""
picoGPT - Ein minimaler GPT-Transformer implementiert nur mit NumPy
...
class PicoGPT:
    ...
    def __init__(self, vocab_size, embedding_dim, num_heads, num_layers, max_seq_len=512):
        ...
        print(f"\n{'='*60}")
        print(f"PICOGPT INITIALISIERUNG")
        print(f"{'='*60}")
...
def demo_with_tokenizer():
    """
    Demo die zeigt, wie SubwordTokenizer + picoGPT zusammenarbeiten
    """
    print("\n" + "="*60)
    print("KOMPLETTE PIPELINE: TOKENIZER + PICOGPT")
    print("="*60)
...
# Token-IDs → NumPy Array für picoGPT
token_array = np.array([token_ids])  # [1, seq_len]

# Forward Pass durch picoGPT
...
def demo():
    print("\n" + "="*60)
    print("PICOGPT DEMO - TRANSFORMER NUR MIT NUMPY")
    print("="*60)
